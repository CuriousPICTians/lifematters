...
<form method="post" action="" name="myForm3" action="" onsubmit="return validateForm();">
...
<input type="submit" name="submit" class="btn btn-default" value="submit"/>
  <h2>
    <a href='RecieverLogin.php'> Already Account then Login Here..!! </a>
  </h2>
...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		{
			$databse=$con->organ;
			$collection=$databse->receiverinfo;
			...
			if(!count($count))
			{
				$user_data=array('email'=>$uemail,'password'=>$upass,'approved'=>'0' ,'status'=>'pending' );
				$collection->insert($user_data);
?>
                
                <script>alert('Successfully Registered \n	Please Login.'); window.location.href="Rlogin.php";
                </script>
