...
<h4> Thank You for Registration as a Donor.....!!  We Contact you as Soon as..!! </h4>
<br>

<label> For More Information Here:- </label> 
<input type="button" value="Login"  class="btn btn-default" onclick="window.location.href='DonorLogin.php'">
