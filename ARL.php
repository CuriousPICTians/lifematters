  	...
  	$temp = $collection -> find(array('_id' => new MongoId($_GET['order'])));
		...
		foreach($temp as $venue)
		{
		  $collection -> update(array('_id' => new MongoId($_GET['order'])), array('$set' => array('status' => 'pending','Doc' => 'unlink')));
			?>
			<script>alert("Patient has been Deleted Successfully..!!"); window.location.href="ApproveReceiver.php";</script>
			<?php
...
if(isset($_GET['key']))
  {
	  ...
	  echo "<table class='table table-bordred table-responsive table-striped table-hover custab table-condensed custab'>
       <h4 style='text-align:center;'> <b> Receiver Details </b> </h4> 
      <tr>
        <th> Name </th>
        <th> Gender</th>
        <th> DOB </th>
...
?>
        <button class='btn btn-success btn-xs w3-purple' onclick= "window.location.href='ApproveReceiver.php' " ><span class=''> BACK</span></button>
<?php echo"
        </td>
      </tr>
      </table>";
  ...
  if(isset($_GET['process']))
  {
		...
		{
			?>
			<script>alert("Patient confirmed already..!!"); window.location.href="ApproveReceiver.php"; </script> </script>
			<?php
		}	
		else
		{
		...
		?>
		<script>alert("Patient has been Confirmed..!!"); window.location.href="ApproveReceiver.php"; </script> </script>
		<?php
  		}
  		}
  }
 ...
 <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Record?</div>
        ...
        <?php echo "<div class='action'> <a href='ARL.php?order=".$venue['_id']."'> 
...
<div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
       ...
       <?php echo "<div class='action'> <a href='ARL.php?process=".$venue['_id']."'> 
