		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">
					...
					<span class="hidden-xs"> Receiver </span>
	...
	<article class="wrapper">
	    ...
	    <aside class="sidebar">
	        <ul class="sidebar-nav">
			    <li class="active"><a href="RecieverDetail.php" target="cp"><i class="fa fa-dashboard"></i> <span> Receiver detail </span></a></li>
			    <li><a href="RecieverUpdate.php" target="cp" ><i class="fa fa-cogs"></i> <span> Update Information </span></a></li>
...
<div id="section">
					<iframe src="RecieverDetail.php" name="cp" width="1280px" height="570px" style="border:none" ></iframe>
				</div>
