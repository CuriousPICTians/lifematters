...
{
    var x = document.forms["myForm23"]["email"].value;
    var atpos = x.indexOf("@");
...
<form method="post" action="" name="myForm23" action="" onsubmit="return validateForm();">
...
<input type="submit" name="submit" class="btn btn-default" value="submit"/>
  <h5>
  <b>  <a href='DoctorLogin.php'> Already Account then Login Here..!! </a> </b>
  </h5>
...
?>
                ...
                <script>alert('Successfully Registered \n	Please Login.'); window.location.href="DoctorRegistration.php";
                </script>
