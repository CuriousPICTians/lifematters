		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand ">
					...
					<span class="hidden-xs "> Organ Donation </span>
	...
	<article class="wrapper">
	    ...
	    <aside class="sidebar">
	        <ul class="sidebar-nav">
			    <li class="active"><a href="Default.php" target="cp" ><i class="fa fa-dashboard "></i> <span> Doctor Details </span></a></li>
			    <li><a href="Psearch.php" target="cp" ><i class="fa fa-cogs"></i> <span> Search Patient </span></a></li>
			    <li><a href="ListDonor.php" target="cp"><i class="fa fa-users"></i> <span> Donor List </span></a></li>
			    <li><a href="ListReceiver.php" target="cp"><i class="fa fa-users"></i> <span> Receiver List </span></a></li>
			    <li><a href="Mreport.php" target="cp"><i class="fa fa-envelope"></i> <span> Reports </span></a></li>
		    </ul>
	    </aside>
