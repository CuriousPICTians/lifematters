	...
	<article class="wrapper">
	    ...
	    <aside class="sidebar">
	        <ul class="sidebar-nav">
			    <li class="active"><a href="DonorDetail.php" target="cp"><i class="fa fa-dashboard"></i> <span> Donor detail </span></a></li>
			    <li><a href="DonarUpadate.php" target="cp" ><i class="fa fa-cogs"></i> <span> Update Information </span></a></li>
...
<div id="section">
					<iframe src="DonorDetail.php" name="cp" width="1280px" height="570px" style="border:none" ></iframe>
				</div>
